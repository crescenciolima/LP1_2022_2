# LP1_2022_2
Código desenvolvido na disciplina Linguagem de Programação 1 (LP1) semestre 2022.2

Neste repositório você vai encontrar os códigos produzidos durante as aulas presenciais da disciplina LP1 do Instituto Federal de Educação, Ciência e Tecnologia da Bahia (IFBA) campus Vitória da Conquista semestre 2022.2 do curso Bacharelado em Sistemas de Informação (noturno). 
...
Clone the project
        ...
        gitclone https://github.com/cretchas/LP1_2022_2.git
